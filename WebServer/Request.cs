...
namespace WebServer
{
    ...
    public class BaseRequest
    {
        ...
        //        public string[] ParsedUri { get; private set; }
        ...
        {
            LoadBaseRequest(bRawRequest, contentStart, contentSize, headerFields, requestType);
        }

        protected void LoadBaseRequest(byte[] bRawRequest, int contentStart, int contentSize, Hashtable headerFields, EnumRequestType requestType)
        {
        ...
        protected static int GetHeaderLength(byte[] buffer)
        {
            int contentStart = -1;
        ...
        private static EnumRequestType GetRequestType(byte[] bRawRequest)
        {
